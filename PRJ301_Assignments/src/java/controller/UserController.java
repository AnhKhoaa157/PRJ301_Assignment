...
public class UserController extends HttpServlet {
    ...
    private static final String SEARCH_PAGE = "MainController?page=searchUser";
    private UserDAO userDAO = new UserDAO();

    public String processdeleteUser(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        String url = SEARCH_PAGE; // Sử dụng ADMIN_PAGE đã thay đổi
        ...
        // Quay lại trang search với page=searchUser
        return url;
    }
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (action == null && page == null) {
                ...
                url = processdeleteUser(request, response);
            }
